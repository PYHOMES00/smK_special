    ...
    try:
        ...
        if user.status == "kicked":
            await bot.send_message(
                ...
                text="Sorry Sir, You are Banned to use me. Contact my [◤ꜱᴜᴘᴘᴏʀᴛ☯ɢʀᴏᴜᴘ◢](https://t.me/Mr_Persis_Bot).",
        ...
        await bot.send_message(
            chat_id=cmd.from_user.id,
            text="Something went Wrong. Contact my [◤ꜱᴜᴘᴘᴏʀᴛ☯ɢʀᴏᴜᴘ◢](https://t.me/Mr_Persis+_Bot).",
            disable_web_page_preview=True
        )
        return 200
    return 200
